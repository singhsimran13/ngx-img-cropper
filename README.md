...
![example](https://github.com/singhsimran13/ngx-img-cropper/raw/main/cropper-example.png)

Upgarded version of ngx-image-cropper "7.2.1" visit [github](https://github.com/Mawi137/ngx-image-cropper)
...
``` typescript
import { ImageCroppedEvent, LoadedImage } from 'ngx-img-cropper';
